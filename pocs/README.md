...
Runnable proof-of-concept projects live here.
...
| `mcp-tool-gateway` | Tool governance | Route tool calls through a controlled gateway rather than direct agent access |

## Rule

Each POC should prove one architecture pattern. If it proves more than one, split it.
